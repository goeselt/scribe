...
test('buildFooter renders a stable UTC timestamp and generated signature', () => {
  const footer = buildFooter(new Date(Date.UTC(2026, 5, 18, 22, 4, 5)))

  assert.equal(footer, '_Last updated: 2026-06-18 22:04 UTC - Generated by Scribe_')
  assert.ok(footer.includes(GENERATED_FOOTER), 'generated footer sentinel missing')
})

test('buildComment ends with the generated footer', () => {
  const comment = buildComment('', versionRecord, new Date(Date.UTC(2026, 5, 18, 22, 4, 5)))

  assert.ok(comment.endsWith('_Last updated: 2026-06-18 22:04 UTC - Generated by Scribe_'))
})
